    ...
    <div class="container">
        <div class="footer__wrapper">
            <div class="footer__top">
                <div class="hashteg">#TheTastEat</div>
                ...
                <div class="footer__social-links">
                    <a class="footer__social-link footer__social-link--instagram"
                        href="<?php the_field('instagram_link'); ?>"><svg class="footer__social-icon"
                    ...
                    <a class="footer__social-link footer__social-link--facebook"
                        href="<?php the_field('facebook_link'); ?>"><svg class="footer__social-icon"
                            xmlns="http://www.w3.org/2000/svg" width="24" height="23" viewBox="0 0 24 23" fill="none">
                    ...
                    <a class="footer__social-link footer__social-link--pinterest"
                        href="<?php the_field('twitter_link'); ?>"><svg
                    ...
                    <a class="footer__social-link footer__social-link--twitter"
                        href="<?php the_field('pinterest_link'); ?>"><svg
                            class="footer__social-icon footer__social-icon--twitter" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="footer__middle">
                <div class="footer__contacts">
                    <h3 class="footer__title-third title-third">Contact</h3>
                    <div class="footer__information">
                        <address class="footer__address"><?php the_field('address'); ?></address>
                        <a class="footer__phone"
                            href="tel:<?php the_field('phone_number'); ?>"><?php the_field('phone_content-footer'); ?></a>
                        <a class="footer__email"
                            href="mailto:<?php the_field('email'); ?>"><?php the_field('email'); ?></a>
                    </div>
                </div>
                <div class="footer__subscribe">
                    <p class="footer__subscribe-description">Join our mailing list for updates,<br>Get news
                        & offers
                        events.</p>
                    <form class="footer__subscribe-form" action="#" method="#">
                        <?php echo do_shortcode('[contact-form-7 id="1cabca6" title="Контактная форма - подписка"]') ?>
                    </form>
                </div>
                <div class="footer__working-hours">
                    <h3 class="footer__title-third title-third">Working Hours</h3>
                    <div class="footer__time">
                        <div class="footer__working-hours-item">Mon – Fri:<time>
                                <?php the_field('work-time_weekdays'); ?></time>
                        </div>
                        <div class="footer__working-hours-item">Sat:<time>
                                <?php the_field('work-time_saturday'); ?></time>
                        </div>
                        <div class="footer__working-hours-item">Sun:<time>
                                <?php the_field('work-time_sunday'); ?></time>
                        </div>
                    </div>
                </div>
            </div>
            <div class="footer__bottom">
                <span class="footer__info-item-text">© Copyright - TastEat</span>
                <span class="footer__info-item-text">2023 developed by github.com/maxbelovcz</span>
            </div>
        </div>
    </div>
</footer>
